...
describe("Basic", () => {
  test("tbl_name", () => {
    ...
    expectTypeOf(tf).toEqualTypeOf<["tbl_name"]>();
  });
});
...
describe("Single Joins", () => {
  test("tbl_name1 JOIN tbl_name2", () => {
    ...
    expectTypeOf(jt).toEqualTypeOf<["tbl_name1", "tbl_name2"]>();
  });
...
describe("Multiple Joins", () => {
  test("tbl_name1 JOIN tbl_name2 JOIN tbl_name3", () => {
    ...
    expectTypeOf(jt).toEqualTypeOf<["tbl_name1", "tbl_name2", "tbl_name3"]>();
  });
...
describe("Multiple table references", () => {
  test("tbl_name1, tbl_name2", () => {
    ...
    expectTypeOf(tf).toEqualTypeOf<["tbl_name1", "tbl_name2"]>();
  });

  test("tbl_name1, tbl_name2 JOIN tbl_name3", () => {
    const tf = parseTableReferences("tbl_name1, tbl_name2 JOIN tbl_name3");
    expectTypeOf(tf).toEqualTypeOf<["tbl_name1", "tbl_name2", "tbl_name3"]>();
  });
  ...
  test("tbl_name1, tbl_name2 JOIN tbl_name3, tbl_name4", () => {
    ...
    expectTypeOf(tf).toEqualTypeOf<["tbl_name1", "tbl_name2", "tbl_name3", "tbl_name4"]>();
  });
});
